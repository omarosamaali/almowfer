...
const faqItems = [
    {
        ...
        a: 'المسوق، موقعاً وتطبيقاً هو أفضل منصة اعلانية للشركات الناشئة والمتوسطة والكبيرة في السعودية والإمارات والكويت ومصر والعالم العربي، يمتاز بحلوله وأدواته التسويقية الشاملة والاعتماد على الإعلان المستهدف والمباشر الذي يحقق عائداً هائلاً على الاستثمار.',
    },
    {
        q: 'ما أفضل استراتيجيات الإعلان على المسوق؟',
    ...
    {
        q: 'ما اسعار الإعلانات الرقمية على المسوق؟',
