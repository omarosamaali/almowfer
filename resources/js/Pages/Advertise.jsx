...
const faqItems = [
    {
        q: 'ما هي افضل منصة اعلانية؟',
        a: 'الموفر، موقعاً وتطبيقاً هو أفضل منصة اعلانية للشركات الناشئة والمتوسطة والكبيرة في السعودية والإمارات والكويت ومصر والعالم العربي، يمتاز بحلوله وأدواته التسويقية الشاملة والاعتماد على الإعلان المستهدف والمباشر الذي يحقق عائداً هائلاً على الاستثمار.',
    },
    {
        q: 'ما أفضل استراتيجيات الإعلان على الموفر؟',
        a: 'نحن نبذل كل ما يوسعنا لتلبية جميع احتياجاتك معتمدين على مرونة وتنوّع هائلَين في الاستراتيجيات التسويقية والإعلانية المتاحة، تشمل زيادة الوعي بعلامتك التجارية وتوسيع قاعدة العملاء بل والتعرّف عليهم أكثر، زيادة المبيعات، زيادة عدد مرات تحميل التطبيق، توليد حركة زوار إضافية، زيادة حصة الشركة من السوق السعودي والمزيد.',
    },
    {
        q: 'ما اسعار الإعلانات الرقمية على الموفر؟',
        a: 'الأسعار متنوّعة وتختلف باختلاف الخطة الإعلانية التي تختارها، مدّتها وأهدافها. تواصل معنا الآن!',
    },
];
...
const features = [
    ...
    { icon: '📱', title: 'موقع وتطبيق', desc: 'الظهور على موقع الموفر وتطبيقه الذكي في آن واحد لأقصى وصول ممكن لجمهورك المستهدف.' },
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                            ...
                            <div className="text-right order-2 lg:order-1">
                                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-800 leading-snug mb-5">
                                    ابدأ بزيادة المبيعات وضمان ازدهار علامتك التجارية مع الموفر
                                </h1>
                                <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-5">
                                    نحن نوفر الفرصة عبر منصتنا (موقع وتطبيق الموفر) لمختلف العلامات التجارية للإعلان معنا عبر باقات مدفوعة، لنعزّز بذلك ظهورها وزيادة الوعي بها. الشراكة معنا تتيح لك الظهور والوصول إلى قاعدة عملاء أكبر وأوسع، وبالتالي إلى زيادة المبيعات بشكل هائل.
                                </p>
                            </div>
                            ...
                            <div className="order-1 lg:order-2 grid grid-cols-2 gap-3">
                                ...
                                >
                                    <div className="text-white font-black text-2xl text-center leading-snug">
                                        اصبح اسهل مع.<br />تطبيق وموقع الموفر
                                    </div>
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs font-black text-white">وفّر أكثر مع<br />الموفر</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-10">
                    ...
                    <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm mb-8 text-right">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            احصل على أفضل حملة اعلانية فعالة في العالم العربي عبر الموفر، موقعاً وتطبيقاً، حيث يمكنك الترويج لمنتجاتك وخدماتك وزيادة الوعي بعلامتك التجارية وغيرها الكثير وغيرها الكثير بأفضل تكاليف.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            بوصفه أفضل موقع وتطبيق كوبونات وعروض خصم في العالم العربي، فإن الموفر هو أفضل منصة إعلانية للشركات والعلامات التجارية والمشاريع الصغيرة والمتوسطة والكبيرة التي تسعى لإطلاق حملات إعلانية متعددة الأهداف تستهدف الجماهير في المملكة العربية السعودية بالمقام الأول، إلى جانب الإمارات العربية المتحدة، مصر والكويت والمزيد.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            إن الإعلان عبر الموفر يضمن مضمون النتائج، ويحقق لك أعلى عائد على الاستثمار. الشراكة معنا تتيح لك تنفيذ كافة استراتيجياتك التسويقية بكل احتياجاتك بكل تأكيد وتوفر لك المجهود والمال.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed">
                            الأمر المدهش حول الموفر أنه ليس مجرد منصة إعلانية بل تطبيق خدمات لا يطبق خدمات بتوفير أقوى الكوبونات والخصومات للأهم المتاجر الإلكترونية والعلامات التجارية المحلية والعالمية، ولذلك هو منصة تفاعلية جداً بفضلها استقطاب عشاق التسوق عبر الإنترنت للحصول على أفضل توفير المال.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm mb-8 text-right">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            أفضل طريقة عمل إعلان في عالم التسوق عبر الإنترنت هي الإعلان في الموفر، موقعاً أو تطبيقاً، مساء أنت أردت في ترويج منتجاتك أو إطلاق حملة لزيادة الوعي بعلامتك التجارية أو زيادة عدد تحميل التطبيق الخاص بك، فأنت ستجد ما تحتاجه لديك في الموفر المقدمة بأفضل باقات تفاعلية مدمجة.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            من أجل من خلال إطلاق حملة إعلانية عبر موقع الموفر أو تطبيقه فأنك ستحقق الوصول المباشر والفعّال إلى ملايين العملاء، سواء من خلال إعلانات الراية أو الإعلانات المبثقة أو الإشعارات أو حتى من منصات التواصل الاجتماعي وغيرها من حلول الذكاء الاصطناعي التي نعتمدها بكل احتياجاتك التسويقية سنتائي وتوفر لك المجهود والمال.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            الأمر الرائع هو أن الإعلان عبر الموفر ناجح دائماً لأن الحملات الإعلانية ستعمل على تلبية احتياجات الجماهير الخاصة أن موقعنا وتطبيقنا خاصة أن موقعنا وتطبيقنا خاصة أن الحملات مع جمهور رقمي نسق أن الموقع الرقمي يسوق في عالم رقمي نسق وداينامكيي جداً، وعليه فإن التفاعل مؤكد.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed">
                            وبالتالي، فإن الإعلان عبر الموفر ناجح دائماً لأن الحملات الإعلانية ستعمل على تلبية احتياجات الجماهير الخاصة، مع التركيز على تلبية احتياجاتهم في عالم تسوق رقمي ديناميكي جداً، وعليه فإن التفاعل مؤكد.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        <h2 className="text-xl sm:text-2xl font-black text-gray-800 mb-6 text-center">
                            المفهوم الأحدث للإعلانات الرقمية عبر الموفر
                        </h2>
                    ...
                    <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm mb-8 text-right">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            الموفر هو أفضل منصة اعلانية للشركات في السعودية، سواء أكانت ناشئة أو متوسطة أو كبيرة، حيث يمكنك الاستفادة من حلول وأدوات الإعلان الرقمي المستهدف لها جمهاهير لجماهير مهتمة بالشراء والتسوق عبر الإنترنت، معتمداً على خبرتنا الطويلة في توفير المال الذي يقوم على الأساس، والتي نقوم على النمو والتحديث المستمر.
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            لا يقتصر الأمر عند إنشاء حملة إعلانية عبر الموفر على الإعلانات النموذجية، بل الأمور هذا يتجاوز ذلك إلى الإعلان عبر موقعنا وتطبيقنا والإعلان عبر الكوابل المبثقة والعروض المبثقة من خلالها من خيرتنا من خيرتنا مستفيدين من الأسعار الشائقة والعروض التوفيرية، كافة منصات التواصل الاجتماعي التي ندبرها، إلى جانب الإشعارات والبريد الإلكتروني والنشرات الإخبارية والمزيد، مع نسبة تفاعل هائلة.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm mb-8">
                        <h2 className="text-xl sm:text-2xl font-black text-gray-800 mb-6 text-center">
                            الأسئلة الشائعة حول الموفر كمنصة إعلانية للشركات في السعودية والعالم العربي
                        </h2>
