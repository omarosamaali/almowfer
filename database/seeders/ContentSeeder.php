...
class ContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $advertiseFaqs = [
            ['q' => 'ما هي افضل منصة اعلانية؟', 'a' => 'المسوق، موقعاً وتطبيقاً هو أفضل منصة اعلانية للشركات الناشئة والمتوسطة والكبيرة في السعودية والإمارات والكويت ومصر والعالم العربي، يمتاز بحلوله وأدواته التسويقية الشاملة والاعتماد على الإعلان المستهدف والمباشر الذي يحقق عائداً هائلاً على الاستثمار.', 'context' => 'advertise'],
            ['q' => 'ما أفضل استراتيجيات الإعلان على المسوق؟', 'a' => 'نحن نبذل كل ما يوسعنا لتلبية جميع احتياجاتك معتمدين على مرونة وتنوّع هائلَين في الاستراتيجيات التسويقية والإعلانية المتاحة، تشمل زيادة الوعي بعلامتك التجارية وتوسيع قاعدة العملاء بل والتعرّف عليهم أكثر، زيادة المبيعات، زيادة عدد مرات تحميل التطبيق، توليد حركة زوار إضافية، زيادة حصة الشركة من السوق السعودي والمزيد.', 'context' => 'advertise'],
            ['q' => 'ما اسعار الإعلانات الرقمية على المسوق؟', 'a' => 'الأسعار متنوّعة وتختلف باختلاف الخطة الإعلانية التي تختارها، مدّتها وأهدافها. تواصل معنا الآن!', 'context' => 'advertise'],
        ];

        foreach ($advertiseFaqs as $index => $faq) {
            Faq::updateOrCreate(
